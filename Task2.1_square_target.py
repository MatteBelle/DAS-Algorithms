...
r = np.zeros((MAXITERS, NN, dd))
r[0] = np.array([[1,1], [1,-1], [-1,-1], [-1,1]])
print(r)
def phi(z):
    return z
...
for kk in range(MAXITERS - 1):
    ...
    r[kk + 1] = np.array([r[kk,0] - [0.0005,0.0005], r[kk,1] - [0.0005,-0.0005], r[kk,2] - [-0.0005,-0.0005], r[kk,3] - [-0.0005,0.0005]])
